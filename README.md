...
#Longest Palindromic Sequence
	...
	we can find out the maximum length  of palindromic string of a  given string.
...
public class LongestPalindromicSequence {
	...
	public static void main(String[] args) {
		...
		System.out.println("Largest Palindromimc String length:"+len);
	}

}

O/p: Largest Palindromimc String length:6
